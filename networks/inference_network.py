...
class ConInferenceNetwork(nn.Module):
    ...
    def __init__(self, input_size, bert_size, output_size, hidden_sizes,
        ...
        self.input_layer = nn.Linear(20000, hidden_sizes[0])
    ...
    def forward(self, x, labels=None):
        ...
        #print("linear layer:", self.input_layer.weight)
        ...
        #print("f_mu_batchnorm:", mu)
        log_sigma = self.f_sigma_batchnorm(self.f_sigma(x))
        #print("f_sigma_batchnorm:", log_sigma)
...
class CombinedInferenceNetwork(nn.Module):
    ...
    def __init__(self, input_size, bert_size, output_size, hidden_sizes,
        ...
        self.adapt_bert = nn.Linear(768, input_size)
        ...
        self.f_mu = nn.Linear(hidden_sizes[-1], self.output_size)
        self.f_mu_batchnorm = nn.BatchNorm1d(self.output_size, affine=False)

        self.f_sigma = nn.Linear(hidden_sizes[-1], self.output_size)
        self.f_sigma_batchnorm = nn.BatchNorm1d(self.output_size, affine=False)
