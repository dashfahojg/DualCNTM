...
def align_wikipedia_titles(xml_path, lang_pair):
...
def combine_multilingual_wikipedia_articles(aligned_titles, lang1_articles, lang2_articles, lang1='de', lang2='en'):
    ...
    print(df_merged)
    #df_merged = pd.DataFrame.from_dict(df_merged)
    csv_file = "/home/ssliang/M3L-topic-model/newtrain.csv"
    df.to_csv(csv_file, index=False)
    print("Done! Saved Wikipedia articles as", csv_file, "!")
    return df_merged


def extract_wikipedia_image_urls(image_tsv='00000-of-00001.tsv', lang='en'):
